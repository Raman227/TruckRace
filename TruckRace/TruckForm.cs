...
namespace TruckRace
{
    public partial class TruckForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            Racers[0] = pFactory.getRacer("Rajdeep", MaximumBet, RajdeepBet); //getting Rajdeep object from factory class
            Racers[1] = pFactory.getRacer("Raman", MaximumBet, RamanBet); //getting Raman object from factory class
            Racers[2] = pFactory.getRacer("Lovedeep", MaximumBet, LovedeepBet); //getting Lovedeep object from factory class
